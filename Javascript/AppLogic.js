          ...
          type: "nav", class: "AppLogic_Navbar nav-wrapper row", elements: [
                ...
                this.tabNav = CreateElement({
                  type: "div", elements: [
                    this.playButton = CreateElement({
                      type: "button",
                      class: "AppLogic_NavButtonSelected",
                      text: this.translate("play")
                    }),
                    this.masteriesButton = CreateElement({
                      type: "button",
                      class: "AppLogic_NavButton",
                      text: this.translate("masteries")
                    }),
                    this.runesButton = CreateElement({
                      type: "button",
                      class: "AppLogic_NavButton",
                      text: this.translate("runes")
                    }),
                    this.settingsButton = CreateElement({
                      type: "button",
                      class: "AppLogic_NavButton",
            ...
            this.rightNav = CreateElement({
              type: "div", class: "col s3 right-align", elements: [
                this.minimize = CreateElement({
                  type: "span",
                  id: "min-btn",
                  class: "fa fa-window-minimize AppLogic_Button"
                }),
                this.maximize = CreateElement({
                  type: "span",
                  id: "max-btn",
                  class: "fa fa-window-maximize AppLogic_Button"
                }),
                this.close = CreateElement({
                  type: "span",
                  id: "close-btn",
                  class: "fa fa-window-close AppLogic_Button"
                })
              ]
            })
          ]
